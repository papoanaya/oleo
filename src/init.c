/*
 * $Id: init.c,v 1.2 2012/08/29 23:48:22 papo Exp $
 *
...
# endif	/* WITH_GNUPLOT */
  ...
  "[A]scii, [C]sv, [G]roff or [P]ostscript printing? ",
  "",
  "bind-key print-commands print-region a",
  "bind-key print-commands print-region A",
  "",
  "create-keymap grprint-commands universal",
  "bind-key print-commands grprint-region g",
  "bind-key print-commands grprint-region G",
  "",
  "create-keymap csvprint-commands universal",
  "bind-key print-commands csvprint-region c",
  "bind-key print-commands csvprint-region C",
  "",
