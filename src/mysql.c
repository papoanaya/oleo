/*
 *  $Id: mysql.c,v 1.2 2012/09/03 01:50:57 papo Exp $
 *
...
static char rcsid[] = "$Id: mysql.c,v 1.2 2012/09/03 01:50:57 papo Exp $";
...
do_mysql_query(struct value *p)
{
	...
	if (mysql_real_connect(&db, Global->DatabaseGlobal->host, Global->DatabaseGlobal->user, "","",0,NULL,0)
			== NULL) {
...
MySQLRead(void)
{
	...
	if (mysql_real_connect(&db, Global->DatabaseGlobal->host, Global->DatabaseGlobal->user, "","",0,NULL,0) == NULL) {
