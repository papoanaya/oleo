/*
 * $Id: defun.h,v 1.2 2012/08/29 23:49:38 papo Exp $
 *
...
DEFUN ("grprint-region", FDgrprint_region, FAgrprint_region, grprint_region_cmd)
#ifdef FUNC_ARG_STRINGS
"rRegion? ",
"fwPrint to file? ",
#endif
#ifdef DOC_STRINGS
"Print (in Groff) the contents of REGION to FILE.",
#endif


DEFUN ("csvprint-region", FDcsvprint_region, FAcsvprint_region, csvprint_region_cmd)
#ifdef FUNC_ARG_STRINGS
"rRegion? ",
"fwPrint to file? ",
#endif
#ifdef DOC_STRINGS
"Print (in CSV) the contents of REGION to FILE.",
#endif
