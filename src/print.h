 ...
 * 
 * $Id: print.h,v 1.2 2012/08/29 23:51:09 papo Exp $
 * 
...
extern void grprint_region (FILE * fp, struct rng * rng, float wid, float hgt, char * font);
extern void csvprint_region (FILE * fp, struct rng * rng, float wid, float hgt, char * font);

extern void set_page_size_cmd (char * whole_str);
extern void print_region_cmd (struct rng *rng, FILE *fp);
extern void grprint_region_cmd (struct rng *rng, FILE *fp);
extern void csvprint_region_cmd (struct rng *rng, FILE *fp);
